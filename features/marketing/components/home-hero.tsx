...
type CollageImage = (typeof heroContent.collageImages)[number];

function HeroCollageBackground({
  primary,
  secondaryImages,
}: {
  primary: CollageImage;
  secondaryImages: CollageImage[];
}) {
  return (
    <>
...
export function HomeHero() {
  ...
  return (
    <section className="relative min-h-[640px] overflow-hidden lg:min-h-[720px]">
      <HeroCollageBackground primary={primary} secondaryImages={secondaryImages} />
